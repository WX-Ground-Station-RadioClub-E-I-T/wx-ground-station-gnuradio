...
class WXsat_APT_no_gui(gr.top_block):

    def __init__(self, freq=1371000000):
...
def argument_parser():
    ...
    parser.add_argument(
        "--freq", dest="freq", type=intx, default=1371000000,
        help="Set Frequency of the satellite [default=%(default)r]")
    return parser


def main(top_block_cls=WXsat_APT_no_gui, options=None):
    if options is None:
